...
(function () {
  ...
  var OnePageNav = function () {
    var navToggler = $(".anurag-js-nav-toggle");
    $(".smoothscroll[href^='#'], #anurag-navbar ul li a[href^='#']").on(
      "click",
      function (e) {
        e.preventDefault();
        var hash = this.hash;
    ...
    $("#anurag-navbar ul li a[href^='#']").on("click", function (e) {
  ...
  $(window).scroll(function () {
    var $this = $(this),
      st = $this.scrollTop(),
      navbar = $(".anurag-header"),
      logo = $(".anurag-header .logo> img");
    if (st > 150) {
  ...
  $(".anurag-js-nav-toggle").on("click", function (e) {
    var $this = $(this);
    e.preventDefault();
    if ($("body").hasClass("menu-open")) {
      $this.removeClass("active");
      $(".anurag-menu .anurag-menu-inner > ul > li").each(function (i) {
        var that = $(this);
        setTimeout(function () {
      ...
      setTimeout(function () {
        $(".anurag-menu").removeClass("anurag-menu-show");
      }, 800);
      $("body").removeClass("menu-open");
    } else {
      $(".anurag-menu").addClass("anurag-menu-show");
